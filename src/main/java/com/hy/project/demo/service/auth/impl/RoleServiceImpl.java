...
import com.hy.project.demo.security.SysAuthority;
...
import static com.hy.project.demo.constant.RedisConstants.KEY_ROLES;
...
public class RoleServiceImpl implements RoleService {
    ...
    public LoginUser buildLoginUser(SysUser user) {
        ...
        roles.forEach(role -> role.getPermissions().forEach(permission -> allPermissionKeys.add(permission.getPermissionKey())));
